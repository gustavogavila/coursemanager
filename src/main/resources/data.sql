...
INSERT INTO public.course(
	id, description, name, teacher_id)
	VALUES (nextval('course_id_seq'), 'Programa Geral', 'PG', 1),
	(nextval('course_id_seq'), 'Programa Fundamental', 'PF', 2),
	(nextval('course_id_seq'), 'Programa de Formação de Professores', 'PFP', 1);
